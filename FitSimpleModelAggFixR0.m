function [paramfitAggFixp]= FitSimpleModelAggFixR0(R0b)
%close all
warning off;
...
lb = [I01g*.5,.01, 0 , .01 , I02g*.5, .01 , 0 , .01];
ub = [I01g*2,.10, inf , 1  ,I02g*2, .10 , inf , 1];
