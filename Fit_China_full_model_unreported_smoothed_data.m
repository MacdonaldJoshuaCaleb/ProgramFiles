...
ps0=1/sigma0*(ddr-(1-p0)/p0*phi1)
 paramguess=[I0g,Mc0g,betag,phi1,theta,sigma0,nu0,thetac0,p0,alpha0,I0cg,I0ccg,Tg];
 lb=zeros(1,length(paramguess));
 %lb(3)=betag*.25;
 %lb(end-4)=0.95;
 lb(end)=3;
 %lb(4)=T_eg;
 ub=[10*I0g,10*Mc0g,10/N/Tg,1,.5,4000,1,.5,.2,.005,10*I0cg,10*I0ccg,7];
% 
% td=0:7:Ng*7;
% l1=length(td)
% NG-2
...
save('parametersNp2FLwinc2ccR2etsm2.mat','paramfit');
T=paramfit(13)
