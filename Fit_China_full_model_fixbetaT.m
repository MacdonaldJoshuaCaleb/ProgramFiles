...
ps0=1/sigma0*(ddr-(1-p0)/p0*phi1)
 paramguess=[I0g,Mc0g,phi1,theta,sigma0,nu0,p0,alpha0,I0cg,I0ccg];
 lb=zeros(1,length(paramguess));
 %lb(3)=betag*.25;
 %lb(end-4)=0.95;
 %lb(4)=.2;
 ub=[10*I0g,10*Mc0g,1,.15,4000,1,.1,.1,10*I0cg,10*I0ccg];
% 
% td=0:7:Ng*7;
% l1=length(td)
% NG-2
...
save('parametersNp2FLwinc2ccR2eth.mat','paramfit');
% betaf=paramfit(3)
betaf=beta
 phif=paramfit(3)
  %fc=paramfit(7)
